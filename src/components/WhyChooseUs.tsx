  ...
  return (
    <section className="py-28 md:py-36 bg-neutral-warm">
      <div className="container">
        ...
        <div ref={gridRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
          {features.map((f, i) => (
            <div
              key={f.title}
              className="text-center bg-background/50 p-8 md:p-10 rounded-sm transition-all duration-700"
              style={{
