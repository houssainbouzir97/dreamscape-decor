...
const BrandStory = () => {
  ...
  return (
    <section className="py-28 md:py-36">
      <div
        ref={ref}
        className="container max-w-3xl text-center transition-all duration-1000"
        style={{
      ...
      >
        ...
        <h2 className="font-heading text-2xl md:text-3xl lg:text-4xl font-normal text-foreground leading-snug tracking-wide">
          Chaque mur mérite une touche d'élégance
        </h2>
