...
const HeroSection = () => (
  <section className="relative overflow-hidden">
    ...
    {/* Text moved lower with more padding */}
    <div className="absolute inset-x-0 bottom-0 pb-6 md:pb-10">
      <div className="text-center px-6 max-w-2xl mx-auto">
        <p className="text-[11px] font-medium uppercase tracking-[0.35em] text-muted-foreground mb-4 animate-fade-up">
          Décoration Murale Premium — Tunisie
        </p>
        <h1 className="font-heading text-4xl md:text-6xl lg:text-7xl font-normal text-foreground leading-[1.1] mb-5 animate-fade-up-delay tracking-[0.04em]">
          Élevez vos murs
        </h1>
        <p className="text-base md:text-lg text-muted-foreground leading-relaxed mb-8 animate-fade-up-delay-2 max-w-lg mx-auto">
