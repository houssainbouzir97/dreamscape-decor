          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {articles.map(article => {
              ...
              return (
                ...
                >
                  {/* Cover image — fixed height, object-contain to avoid cropping product */}
                  <div className="relative overflow-hidden rounded-sm mb-4 bg-secondary/30 flex items-center justify-center" style={{ height: "220px" }}>
                    {coverSrc ? (
                      <img
                        src={coverSrc}
                        alt={article.title}
